// This code is only for easy reference. The directory having all the contracts is:
// https://github.com/semaphore-protocol/semaphore/tree/main/packages/contracts/contracts
